...
for url_link in subscription_links:
    try:
        ...
        if 'ashah404' not in url_link:
            raw_array_links_content.append((url_link, links_content))
        elif 'ashah404' in url_link and 'channels' in url_link:
...
dev_sign = "\U0001F468\U0001F3FB\u200D\U0001F4BB DEVELOPED-BY ashahdevs \U0001F4CC FOLLOW-CONTACT ashahdevs"
